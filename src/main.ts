...
const quizMasterManager: QuizMasterManager | null = null;
const labelManager: LabelManager | null = null;

// Initialize model manager UI
// const modelManager = new ModelManager(renderer);
// modelManager.setOnload(function (obj: Mesh, name: string): void {
// return labelManager?.reset(name, obj);
// });
